...
public class ExcelExportService {
    ...
    private String[] getHeaders() {
        return new String[] {
                ...
                "وزارة التضامن والإدماج الاجتماعي والأسرة (البناء)",
                "التعاون الوطني (البناء)",
                "المبادرة الوطنية للتنمية البشرية (البناء)",
                "الجماعة (البناء)",
                "مؤسسة محمد الخامس للتضامن (البناء)",
                "الإنعاش الوطني (البناء)",
                "الجمعية/مؤسسة (البناء)",
                "مصدر آخر (البناء)",
                "تفاصيل مصدر آخر (البناء)",
                "التكلفة الإجمالية للبناء",
                // مصادر التجهيز
                "وزارة التضامن والإدماج الاجتماعي والأسرة (التجهيز)",
                "التعاون الوطني (التجهيز)",
                "المبادرة الوطنية للتنمية البشرية (التجهيز)",
                "الجماعة (التجهيز)",
                "مؤسسة محمد الخامس للتضامن (التجهيز)",
                "الجمعية/مؤسسة (التجهيز)",
                "مصدر آخر (التجهيز)",
                "تفاصيل مصدر آخر (التجهيز)",
                // مصادر التسيير
                "المبادرة الوطنية للتنمية البشرية (التسيير)",
